...
// ─── FIX 5: Periodic stale session key cleanup ───────────────
//
//  Runs every 2 hours. Deletes pre-key, sender-key, session-*,
//  and app-state files older than 48 hours. Stale signal keys
//  are a primary cause of Bad MAC errors.
//  creds.json is always preserved.
